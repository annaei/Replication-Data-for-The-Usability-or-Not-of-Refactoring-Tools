 ...
 */
package org.navajo.commons.lang.math;
...
public final class Fraction extends Number implements Comparable<Fraction> {
     ...
     * of a fraction Y/Z.</p>
     *
     * @param numer  the numerator, for example the three in 'three sevenths'
     * @param denom the denominator, for example the seven in 'three sevenths'
     */
    private Fraction(final int numer, final int denom) {
        super();
        numerator = numer;
        denominator = denom;
    }
